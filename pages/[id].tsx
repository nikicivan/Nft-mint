      ...
      <div className="bg-gradient-to-br from-cyan-500 to-rose-500 lg:col-span-4">
        <div className='flex flex-col items-center justify-start py-2 lg:min-h-screen'>
          ...
          <div className='text-center p-5 space-y-2'>
            <h1 className="text-4xl font-bold text-white">FUNNY Apes</h1>
            <h2 className="text-xl text-gray-300">A collection of Apes with React & Next NFT Minting</h2>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col p-12 lg:col-span-6">
        ...
        <div className="mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center"> 
          <img
            ...
            alt="content" 
          />
          <h1 className="text-3xl font-bold lg:text-5xl lg:font-extrabold">The Apes NFT Drop Club</h1>

          <p className="pt-2 text-xl text-green-500">13/21 NFT Claimed</p>
        </div>

        {/* Mint button */}
        <button className="h-16 bg-red-600 w-full text-white rounded-full mt-2 font-bold">Mint NFT (0.01 ET)</button>
      </div>
    </div>
  )
}
